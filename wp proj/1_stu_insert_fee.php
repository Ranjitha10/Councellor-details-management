...
<center>
      <form method="post" action="" onSubmit=return formsubmit()>
					...
					<tr><td><br></td></tr>
								...
								<tr><td><br></td></tr>
					<tr><td><font color="black" size=5.8>Challan No. :</font></td><td><input type="text" name="challan" value="<?php echo $challan;?>">
   <span class="error"> <?php echo $challanErr;?></td></tr>
								<tr><td><br></td></tr>
					<tr><td><font color="black" size=5.8>Amount :</font></td><td><input type="text" name="amt" value="<?php echo $amt;?>">
   <span class="error"> <?php echo $amtErr;?></td></tr>
								<tr><td><br></td></tr>
					<tr><td><font color="black" size=5.8>In favour of :</font></td><td><input type="text" name="favour" value="<?php echo $favour;?>">
   <span class="error"> <?php echo $favourErr;?></td></tr>
								<tr><td><br></td></tr>
					<tr><td><font color="black" size=5.8>Date :</font></td><td><input type="int" name="deposit_date" value="<?php echo $deposit_date;?>">
