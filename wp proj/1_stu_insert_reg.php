...
<center>
      <form method="post" action="" >
					<table>
					<tr><td><b><font color="black" size=6>Enter the following details:</font></b></td></tr>
					<tr><td><br></td></tr>
					<tr><td><br></td></tr>
					<tr><td><font color="black" size=5.8>Name:</font></td><td><input type="text" name="name" required="required" value="<?php echo $name;?>">
   <span class="error"> <?php echo $nameErr;?></span></td></tr>
								<tr><td><br></td></tr>
					<tr><td><font color="black" size=5.8>DOB:</font></td><td><input type="int" name="dob" required="required" value="<?php echo $dob;?>"></td></tr>
								<tr><td><br></td></tr>
					<tr><td><font color="black" size=5.8>Sex:</font></td><td>
					<input type="radio" name="sex" value="Male"><font color="black" size=4>Male</font></input>
					<input type="radio" name="sex" value="Female"><font color="black" size=4>Female</font></input>
					</td></tr>
								<tr><td><br></td></tr>
					<tr><td><font color="black" size=5.8>Year of Admission:</font></td><td><input type="text" name="yoa" required="required" value="<?php echo $yoa;?>">
   <span class="error"><?php echo $yoaErr;?></span></td></tr>
								
								<tr><td><br></td></tr>
					<tr><td><font color="black" size=5.8>Email ID:</font></td><td><input type="text" name="e_id" required="required" value="<?php echo $e_id;?>">
   <span class="error"> <?php echo $e_idErr;?></span></td></tr>	
							<tr><td><br></td></tr>
					<tr><td><font color="black" size=5.8>Phone no:</font></td><td><input type="text" name="ph" required="required" value="<?php echo $ph;?>">
   <span class="error"> <?php echo $phErr;?></span></td></tr>	
							<tr><td><br></td></tr>
					<tr><td><font color="black" size=5.8>Address:</font></td><td><textarea rows=4 name="address" required="required" value="<?php echo $address;?>" cols=50></textarea></td></tr>	
							<tr><td><br></td></tr>
					<tr><td><font color="black" size=5.8>Mode of Admission :</font></td><td><select id="text" name="mode"/>
						...
						<option value='MQ'>MQ</option>
								...
								<tr><td><br></td></tr>
					<tr><td><font color="black" size=5.8>Rank:</font></td><td><input type="text" name="rank" required="required" value="<?php echo $rank;?>">
   <span class="error"> <?php echo $rankErr;?></span></td></tr>
								<tr><td><br></td></tr>
					<tr><td><font color="black" size=5.8>Father's Name:</font></td><td><input type="text" name="f_name" required="required" value="<?php echo $f_name;?>">
   <span class="error"><?php echo $f_nameErr;?> </td></tr>	
							<tr><td><br></td></tr>
					<tr><td><font color="black" size=5.8>Father's Contact No.:</font></td><td><input type="text" name="f_no" required="required" value="<?php echo $f_no;?>">
   <span class="error"><?php echo $f_noErr;?></span></td></tr>	
						</td></tr>	
							<tr><td><br></td></tr>
					<tr><td><font color="black" size=5.8>Father's Email ID:</font></td><td><input type="text" name="f_id" required="required" value="<?php echo $f_id;?>">
   <span class="error"> <?php echo $f_idErr;?></span></td></tr>	
							<tr><td><br></td></tr>
					<tr><td><font color="black" size=5.8>Mother's Name:</font></td><td><input type="text" name="m_name" required="required" value="<?php echo $m_name;?>">
   <span class="error"> <?php echo $m_nameErr;?></span></td></tr>	
							<tr><td><br></td></tr>
					<tr><td><font color="black" size=5.8>Mother's Contact No.:</font></td><td><input type="text" name="m_no" required="required" value="<?php echo $m_no;?>">
   <span class="error"><?php echo $m_noErr;?></span></td></tr>	
							<tr><td><br></td></tr>
					<tr><td><font color="black" size=5.8>Mother's Email ID:</font></td><td><input type="text" name="m_id" required="required" value="<?php echo $m_id;?>">
