...
<center>
      <form method="post" action="" onSubmit=return formsubmit()>
					<table>
					<tr><td><b><font color="black" size=6>Fee details:</font></b></td></tr>
					<tr><td><br></td></tr>
					<tr><td><br></td></tr>
					
								<tr><td><br></td></tr>
					<tr><td><font color="black" size=5.8>Challan No. :</font></td><td><input type="text" name="challan" value="<?php echo $challan;?>"/></td></tr>
								<tr><td><br></td></tr>
					<tr><td><font color="black" size=5.8>Amount :</font></td><td><input type="text" name="amt" value="<?php echo $amt;?>"/></td></tr>
								<tr><td><br></td></tr>
					<tr><td><font color="black" size=5.8>In favour of :</font></td><td><input type="text" name="favour" value="<?php echo $favour;?>"/></td></tr>
								<tr><td><br></td></tr>
					<tr><td><font color="black" size=5.8>Date :</font></td><td><input type="int" name="deposit_date" value="<?php echo $deposit;?>"/></td></tr>
								<tr><td><br></td></tr>			
							<tr><td><br></td></tr>
							<tr><td><br></td></tr>
