...
<center>
      <form method="post" action="" onSubmit=return formsubmit()>
					<table>
					<tr><td><b><font color="black" size=6>HSS details:</font></b></td></tr>
					<tr><td><br></td></tr>
					<tr><td><br></td></tr>
					<tr><td><font color="black" size=5.8>Event name :</font></td><td><input type="text" name="e_name" value="<?php echo $u_name; ?>" /></td></tr>
								<tr><td><br></td></tr>
					<tr><td><font color="black" size=5.8>From :</font></td><td><input type="date" name="s_date" required="required"/></td></tr>
								<tr><td><br></td></tr>
					<tr><td><font color="black" size=5.8>To :</font></td><td><input type="date" name="e_date" required="required"/></td></tr>
								<tr><td><br></td></tr>
					<tr><td><font color="black" size=5.8>Category :</font></td><td><select id="text" name="category" required="required" />
