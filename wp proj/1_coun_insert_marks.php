...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
 ...
 ?>
<b><font color="black" size=3><a href="1_coun_insert_excel.php">INSERT through Excel Sheet</a></font></b> 

<center>
     <form method="post" action="" onSubmit="">
					<table>
					<tr><td><b><font color="black" size=6>Enter cie marks  </font></b></td>
					<tr><td><br></td></tr>
				...
				while($row3=$result3->fetch_array(MYSQLI_ASSOC))
				{
					...
					<?php
						...
						?>
								...
								<tr><td><br></td></tr>
					<tr><td><font color="black" size=5.8>Subject Code :</font></td><td><input type="text" name="sub" required="required" value="<?php echo $sub;?>">
   <span class="error"> <?php echo $subErr;?></span></td></tr>
								<tr><td><br></td></tr>
					<tr><td><font color="black" size=5.8>CIE 1 :</font></td><td><input type="integer" name="cie1" required="required" value="<?php echo $cie1;?>">
   <span class="error"> <?php echo $cie1Err;?></span></td></tr>
								<tr><td><br></td></tr>
					<tr><td><font color="black" size=5.8>CIE 2 :</font></td><td><input type="integer" name="cie2" required="required"value="<?php echo $cie2;?>">
   <span class="error"> <?php echo $cie2Err;?></span></td></tr>
								<tr><td><br></td></tr>
					<tr><td><font color="black" size=5.8>CIE 3 :</font></td><td><input type="integer" name="cie3" required="required" value="<?php echo $cie3;?>">
