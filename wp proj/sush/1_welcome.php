...
<div id="header-wrapper">
	<div id="header" class="container">
		...
		<button class="button" style="float: right;" name="Calender of events">calender of events</button> 
		</form>
			<h1 style="color:blue" ><a style="color:blue" href="#">Leave Management System</a></h1>
			<p><b>Leave Management system is an online leave application portal which will automate the process of leave application.</b></p>
		</div>
	</div>
</div>
<div id="page-wrapper">
